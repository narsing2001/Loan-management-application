...
public class JasperReportService {
    ...
    //1. USER LIST REPORT
    public byte[] generateUserListReport(List<UserDTO> users, String generatedBy) throws JRException, IOException , ReportGenerationException {
    ...
    // 2. USER ROLES REPORT
    public byte[] generateUserRolesReport(List<?> userRoleRows, String generatedBy, String filterRole) throws JRException, IOException,ReportGenerationException {
        Map<String, Object> params = new HashMap<>();
        params.put("REPORT_GENERATED_BY", generatedBy);
    ...
    public byte[] generateAuthSummaryReport(List<?> authLogs,String generatedBy, String fromDate,String toDate) throws JRException, IOException,ReportGenerationException {
        Map<String, Object> params = new HashMap<>();
        params.put("REPORT_GENERATED_BY", generatedBy);
    ...
    private byte[] fill(String classpathResource, Map<String, Object> params,JRDataSource dataSource) throws JRException, IOException,ReportGenerationException {
